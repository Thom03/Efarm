 ...
 */
public class khoppcentre extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = ArrayAdapter.createFromResource(this,R.array.kshopping_centre,android.R.layout.simple_spinner_item);
    ...
    public void onButtonRad(View v)
    {
        ...
        {
            Intent y = new Intent(khoppcentre.this, county.class);
            startActivity(y);
        }
